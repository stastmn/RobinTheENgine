...
RTE::vertexShader::vertexShader(std::wstring filePath) :path(filePath)
{
	...
	const D3D11_INPUT_ELEMENT_DESC layout[] =
	{
		...
		D3D11_INPUT_ELEMENT_DESC {"NORMALCOORD", 0,DXGI_FORMAT::DXGI_FORMAT_R32G32_FLOAT,0,D3D11_APPEND_ALIGNED_ELEMENT,D3D11_INPUT_CLASSIFICATION::D3D11_INPUT_PER_VERTEX_DATA, 0},
